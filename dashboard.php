    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <?php if(@$_GET['q']==0)
                {
                   echo "<h1> WELCOME TO Administration Page Site !
					</h1>";
                ...
                <?php 
                    if(@$_GET['q']==1) 
                    {
                        ...
                        <tr><td><center><b>S.N.</b></center></td><td><center><b>Name</b></center></td><td><center><b>university</b></center></td><td><center><b>Email</b></center></td><td><center><b>Action</b></center></td></tr>';
                        $c=1;
                        while($row = mysqli_fetch_array($result)) 
                        {
                            ...
                            <td><center>'.$university.'</center>
                            </td><td><center>'.$email.'<center></td>
